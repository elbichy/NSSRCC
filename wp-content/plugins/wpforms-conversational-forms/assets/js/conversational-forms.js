/* global wpforms_conversational_forms, MobileDetect, tinymce */
...
var WPFormsConversationalForms = window.WPFormsConversationalForms || ( function( document, window, $ ) {
	...
	elements = {
		...
		fieldsErrors      : $( '.wpforms-field-container .wpforms-field .wpforms-error' ),
	...
	helpers = {
		...
		misc: {
			 ...
			 *
			 * @returns {Function} A result function.
			 */
	...
	scrollControl = {
		...
		passive: function() {
			...
			if (
				winScroll > 0 &&
				elements.page.hasClass( 'wpforms-conversational-form-start' ) &&
				! app.isLongDescription()
			) {
				app.scroll.start();
				return;
			}
	...
	mainClasses = {
		...
		FieldItem: ( function() {
			 ...
			 * @since 1.6.0
			 *
			 * @returns {boolean} FieldItem.$el can be scrolled into view.
			 */
	...
	childClasses = {
		...
		fieldItem: {
			...
			Date: ( function() {
				 ...
				 * @since 1.7.0
				 *
				 * @returns {boolean} True if it's a custom datepicker.
				 */
				Date.prototype.isCustomizedDatepicker = function() {
					...
					if (
						typeof window.wpforms_datepicker !== 'undefined' &&
						[ 'range', 'multiple' ].includes( window.wpforms_datepicker.mode )
					) {
						return true;
					}
			...
			Time: ( function() {
				...
				Time.prototype.loadInputMask = function() {
					...
					$.extend( timeInputArgs, { alias: 'datetime', inputFormat: timeInputFormat, placeholder: '_', inputmode: inputMode } );
			...
			/**
			 * Stripe Credit Card hidden input FieldItem child class.
			 *
			 * @since 1.6.0
			 *
			 * @type {object}
			 */
			StripeCreditCardHiddenInput: ( function() {
		...
		fieldItemsSet: {
			...
			/**
			 * Stripe Credit Card FieldItemsSet child class.
			 *
			 * @since 1.6.0
			 */
			StripeCreditCard: ( function() {
	...
	app = {
		 ...
		 * @since 1.10.0
		 *
		 * @returns {boolean} Description is bigger than viewport.
		 */
		isLongDescription: function() {
